...
import { fetchMovieDetails, fetchMovieCredits } from '../features/movies/moviesSlice'
...
function MovieDetail() {
   ...
   return (
      <>
         {/* movieDetails의 초기 state는 null 이므로 movieDetails이 있을때만 값을 보여주도록 함(비동기 통신으로 인해 발생하는 문제)  */}
         {movieDetails && (
